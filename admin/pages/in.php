				...
				<div class="col-md-12">
					<div class="portlet box blue" id="form_wizard_1">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i> Configuration - <span class="step-title">
								Etape 1 sur 4 </span>
							</div>
										...
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab1">
												...
												<div class="form-group">
													<label class="control-label col-md-3">Nom d'utilisateur <span class="required">
													* </span>
													</label>
													<div class="col-md-4">
														<input type="text" class="form-control" name="username"/>
														<span class="help-block">
														Entrer un nom d'utilisateur </span>
													</div>
												</div>
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-4">
														...
														<span class="help-block">
														Entrer un mot de passe </span>
													</div>
												</div>
												<div class="form-group">
													<label class="control-label col-md-3">Confirmer le mot de passe <span class="required">
													* </span>
													</label>
													<div class="col-md-4">
												...
												<div class="form-group">
													<label class="control-label col-md-3">Email pro<span class="required">
													* </span>
													</label>
													<div class="col-md-4">
														<input type="text" class="form-control" name="email"/>
														<span class="help-block">
														Entrer votre email pro </span>
													</div>
												</div>

												<div class="form-group">
													<label class="control-label col-md-3">Email perso<span class="required">
													* </span>
													</label>
													<div class="col-md-4">
														<input type="text" class="form-control" name="email-perso"/>
														<span class="help-block">
														Entrer votre email perso </span>
													</div>
												</div>
											</div>
